...
{
     -16,    13,     9,   -16,    12,   -16,    14,     5,     8,   -16,
     -16,     6,   -16,   -16,   -11,   -16,     6,     6,     6,     6,
      -7,    -7,   -16,   -16
};
...
{
      15,    20,    21,    22,    23,    16,    17,    18,    19,    12,
      13,    18,    19,     3,     4,     7,    10,     8,    11
};

static const yytype_int8 yycheck[] =
{
      11,    16,    17,    18,    19,    16,    17,    18,    19,     3,
       4,    18,    19,     0,     5,     3,    11,     3,    10
};
...
{
       0,    21,    22,     0,     5,    23,    24,     3,     3,    25,
      11,    10,     3,     4,    26,    11,    16,    17,    18,    19,
      26,    26,    26,    26
};
...
#line 83 "parser.y"
        ...
        printf("[ICG] %s = %s\n", (yyvsp[-3].id), (yyvsp[-1].code));
        free((yyvsp[-3].id)); free((yyvsp[-1].code));
    }
...
#line 94 "parser.y"
                              {
        char* temp = new_temp();
        printf("[ICG] %s = %s + %s\n", temp, (yyvsp[-2].code), (yyvsp[0].code));
        free((yyvsp[-2].code)); free((yyvsp[0].code));
        (yyval.code) = temp;
    }
